...
namespace Fs.Web.Authentication
{
	...
	{
		public static void Remember(string uname, string hash)
		{
		...
		public static bool FormAuthenticate(string uname, string clientHash, string lastTicket)
		{
			BasicPassport bp = new SimplePassport();
			return bp.FormAuthenticate(uname, clientHash, lastTicket);
		}
		public static bool RememberAuthenticate()
		{
			BasicPassport bp = new SimplePassport();
