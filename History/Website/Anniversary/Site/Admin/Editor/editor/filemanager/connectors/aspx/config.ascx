...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		TypeConfig[ "File" ].AllowedExtensions			= new string[] { "doc", "jpeg", "jpg", "mp3", "mpeg", "mpg", "rar", "rm", "rmvb", "rtf", "swf", "txt","wav", "wma", "wmv", "xls", "xml", "zip" };
		...
		TypeConfig[ "Media" ].AllowedExtensions			= new string[] { "asf", "avi","mid", "mov", "mp3","mpeg", "mpg", "rm", "rmvb", "swf", "wav", "wma", "wmv" };
