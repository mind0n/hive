...
<head id="Head1" runat="server">
    ...
    <title>后台登录</title>
	<style type="text/css">@import url("<%=RootUrl %>Themes/Admin/login.css");</style>
	<script type="text/javascript" src="<%=RootUrl %>Joy/Joy.js"></script>
    <script type="text/javascript">
	    function refresh() {
		    Joy("authImg").src = '../authcode.aspx?' + new Date();
	    }
    ...
    <div>
                    ...
                    <table border="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="editor">
                                <asp:TextBox ID="txtUserName" Text="admin" runat="server"></asp:TextBox>
							</td><td>
                        ...
                        <tr>
                            ...
                            <td class="editor">
                                <asp:TextBox ID="txtPassWord" Text="empty" runat="server" TextMode="Password"></asp:TextBox>
								</td><td>
                        ...
                        <tr>
                            ...
                            <td class="editor short">
								...
								<img src="../authcode.aspx?rnd=<%=DateTime.Now.Second %>>" alt="看不清？单击此处刷新验证码" id="authImg" border="0" />
								</a>
									</td><td>
