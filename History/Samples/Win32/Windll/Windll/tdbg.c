...
__declspec( dllexport ) VOID WDBGAPI WinDbgExtensionDllInit (PWINDBG_EXTENSION_APIS, USHORT, USHORT);
__declspec( dllexport ) LPEXT_API_VERSION WDBGAPI ExtensionApiVersion (void);
__declspec( dllexport ) CPPMOD VOID dumpstrings ( HANDLE, HANDLE, ULONG, ULONG, PCSTR );
__declspec( dllexport ) CPPMOD VOID help ( HANDLE, HANDLE, ULONG, ULONG, PCSTR );
