...
namespace Site.Admin.AdminDAL
{
    public class OleDbHelper
    {
        ...
        public static readonly string connstr = string.Format("Provider=Microsoft.Jet.OleDb.4.0;Data Source={0}{1};Persist Security Info=True;", AppDomain.CurrentDomain.BaseDirectory, "database.aspx");
