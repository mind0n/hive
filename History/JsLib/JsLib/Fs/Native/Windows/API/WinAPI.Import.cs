...
namespace Fs.Native.Windows.API
{
	public partial class WinAPI
	{
		...
		protected static extern bool vSetCursorPos(int X, int Y);
		public static bool SetCursorPos(double posx, double posy)
		{
			int x = (int)posx;
			int y = (int)posy;
			//if (posx > x + 0.5)
