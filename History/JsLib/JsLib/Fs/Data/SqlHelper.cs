...
namespace Fs.Data
{
	...
	//{
	//    public static string[] MakePagedSelectSql(string pk, string page, string size, string fieldClause, string tableClause, string whereClause, string orderClause, string groupClause);
	//}
	public class SqlHelper
	{
		...
		public static string MakeSafeFieldSql(string FieldVal, DataColumnCollection colinfo, DataColumn col)
		{
			if (colinfo != null)
			{
				...
				if (c != null)
				{
					return MakeSafeFieldSql(FieldVal, c.DataType.ToString(), true);
				}
