...
namespace CaptureTest
{
	public class CaptureTest : System.Windows.Forms.Form
	{
		...
		void CaptureTest_Load(object sender, EventArgs e)
		{
			capture.FrameCaptureComplete += new DirectX.Capture.Capture.FrameCapHandler(capture_FrameCaptureComplete);
			capture.PreviewWindow = panelVideo;
			mnuPreview.Checked = true;
		}

		void CaptureTest_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (capture != null)
			{
				capture.Stop();
		...
		private void InitializeComponent()
		{
            ...
            this.bCaptureFrame = new System.Windows.Forms.Button();
            ...
            this.txtFilename.Location = new System.Drawing.Point(72, 524);
            ...
            this.btnStart.Location = new System.Drawing.Point(2, 484);
            ...
            this.btnStop.Location = new System.Drawing.Point(115, 484);
            this.btnStop.Name = "btnStop";
            this.btnStop.Size = new System.Drawing.Size(62, 21);
            ...
            this.panelVideo.Size = new System.Drawing.Size(177, 142);
            ...
            this.btnCue.Location = new System.Drawing.Point(115, 457);
            this.btnCue.Name = "btnCue";
            this.btnCue.Size = new System.Drawing.Size(62, 21);
            ...
            this.bCaptureFrame.Location = new System.Drawing.Point(3, 457);
            this.bCaptureFrame.Name = "bCaptureFrame";
            this.bCaptureFrame.Size = new System.Drawing.Size(63, 21);
            this.bCaptureFrame.TabIndex = 9;
            this.bCaptureFrame.Text = "Capture";
            this.bCaptureFrame.UseVisualStyleBackColor = true;
            this.bCaptureFrame.Click += new System.EventHandler(this.bCaptureFrame_Click);
            // 
            // spMain
            // 
            ...
            this.spMain.Location = new System.Drawing.Point(10, 11);
            this.spMain.Name = "spMain";
            // 
            // spMain.Panel1
            // 
            this.spMain.Panel1.Controls.Add(this.panelVideo);
            this.spMain.Panel1.Controls.Add(this.btnStop);
            this.spMain.Panel1.Controls.Add(this.btnCue);
            this.spMain.Panel1.Controls.Add(this.btnStart);
            this.spMain.Panel1.Controls.Add(this.bCaptureFrame);
            this.spMain.Size = new System.Drawing.Size(1046, 508);
            this.spMain.SplitterDistance = 180;
        ...
        void capture_FrameCaptureComplete(PictureBox Frame)
        {
            //if (spMain.Panel2.Controls.Count < 1)
            {
                //Frame.Width = 500;
                //Frame.Height = 500;
                //spMain.Panel2.Controls.Add(Frame);
                //Frame.Dock = DockStyle.Fill;
                Recognize(Frame);
            }
        }

	    void Recognize(PictureBox bb)
	    {
            ...
            foreach (CvAvgComp eye in eyes.AsParallel())
            {
                ...
                if (eye.Rect.Left > spMain.Panel2.Width / 2)
                {
                    try
                    {
		...
		private void bCaptureFrame_Click(object sender, EventArgs e)
		{
			try
			{
				if (capture == null)
